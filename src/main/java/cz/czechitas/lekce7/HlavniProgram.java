...
public class HlavniProgram {
    ...
    public static void main(String... args) {
        ...
        System.out.printf("Po smazání Přemysla je v seznamu %d jmen.", svatky.getPocetJmen()).println();
        ...
        System.out.printf("Po přidání Laury, Jarmila, Tamary a Kevina je v seznamu %d jmen.", svatky.getPocetJmen()).println();
    }
